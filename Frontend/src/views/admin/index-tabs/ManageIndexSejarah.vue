<template>
  <div>
    <form @submit.prevent="saveContent">
      <h6 class="text-blueGray-700 text-xl font-bold mb-6 mt-6">Sejarah Singkat OSKA</h6>
...
const CONTENT_BLOCK_KEY = 'index-sejarah-oska';

export default {
  name: "ManageIndexSejarah",
  setup() {
    ...
    const fetchData = async () => {
      try {
        ...
        if (blockData) {
         ...
         Swal.fire({ icon: 'error', title: 'Oops...', text: 'Gagal memuat data sejarah.' });
      }
    };
    ...
    const saveContent = async () => {
      try {
        ...
        Swal.fire({
          icon: 'success',
          title: 'Berhasil!',
          text: 'Konten Sejarah OSKA berhasil diperbarui.',
          timer: 1500,
